...
public class Gridder extends javax.swing.JFrame 
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        for(int i = 0; i < 100; i++){
            grid[(int)(Math.random()*100)][(int)(Math.random()*100)] = 1;
        }
        draw();
    }//GEN-LAST:event_jButton1ActionPerformed
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        int column = (int)(Math.random()*100);
        for(int i = 0; i < 100; i++){
            grid[column][i] = 1;
        }
        draw();
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        ...
        for (int row=0; row < 100; row++)
            for (int col=0; col < 100; col++) {
                ...
                if (row != 99 && grid[col][row+1]==1){
                    neighbor++;
                }
                if (row != 99 && col != 99 && grid[col+1][row+1]==1){
                    neighbor++;
                }
                if (row != 0 && col != 99 && grid[col+1][row-1]==1){
                    neighbor++;
                }
                if (row != 99 && col != 0 && grid[col-1][row+1]==1){
                    neighbor++;
                }
                if (col != 0 && grid[col-1][row]==1){
                    neighbor++;
                }
                if (col != 99 && grid[col+1][row]==1){
                    neighbor++;
                }
                if (row != 0 && col != 0 && grid[col-1][row-1]==1){
                    neighbor++;
                }
                if(neighbor>2){
                    temp[col][row] = 1;
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        ...
        for (int i = 1; i < 100; i++){
            System.arraycopy(grid[i], 0, temp[i - 1], 0, 100);
        }
        System.arraycopy(grid[0], 0, temp[99], 0, 100);
        grid = temp;
        draw();
